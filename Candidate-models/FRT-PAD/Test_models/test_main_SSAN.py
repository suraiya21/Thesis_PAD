...
from networks_SSAN import get_model
...
parser.add_argument("--model_type",type=str, default='SSAN_M', help='direct/dense')
parser.add_argument("--map_size",type=str, default='32', help='direct/dense')
...
def load_net_datasets():
    net = get_model(args.model_type, max_iter=4000).cuda()
    #net_pad = PA_Detector()
...
net.load_state_dict(torch.load('SSAN_M_pO_C_I_to_M_recent.pth')['state_dict'])
